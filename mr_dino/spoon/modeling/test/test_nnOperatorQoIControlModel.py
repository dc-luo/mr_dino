...
sys.path.append("../../../")
from spoon import ControlNeuralOperator, NNControlModel, NNOperatorQoIControlModel, NNSparseL2QoI
...
class TestNNCompleteQoIControlModel(unittest.TestCase):
    ...
    def testEvaluation(self):
        ...
        q_np = self.completeQoIControlModel.cost(m_np, z_np)

        u_np = self.neural_operator.eval(m_np, z_np)
        print("QoI by end to end NN control Model\n", q_np)
